<?php include("_header.php"); ?>
				<div class="col s9">
					<h3>Air Quality</h3> <a href="#!" class="btn btn_small">REST</a>
					
					<p>
						Accessible through https://airduino-ph.000webhostapp.com/api/airquality<br>
							<br>
							<br>
							<b>/getLastFifty.php</b> <span class="btn btn_small">GET</span><br>
								Get the last 50 recent air quality data received. Ordered from newest to oldest.<br>
								<br>
