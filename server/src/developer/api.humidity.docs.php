<?php include("_header.php"); ?>
				<div class="col s9">
					<h3>Humidity</h3> <a href="#!" class="btn btn_small">REST</a>
					
					<p>
						Accessible through https://airduino-ph.000webhostapp.com/api/humidity<br>
							<br>
							<br>
							<b>/getLastFifty.php</b> <span class="btn btn_small">GET</span><br>
								Get the last 50 recent humidity data received. Ordered from newest to oldest.<br>
								<br>
