...
<html>
    ...
    <body class="grey-text text-darken-2">
		...
		<div class="statusbar grey lighten-1">
		  
		</div>
		
        <!-- regular navbar -->
        <nav class='navbar white z-depth-0' id="regularNavbar">
            <div class="left" style="margin-left:5%">
            		<a href='#' onclick="window.history.back()"><i class="material-icons grey-text text-darken-2">arrow_back</i></a>
            </div>
        </nav>
        <!-- regular navbar -->
